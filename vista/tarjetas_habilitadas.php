...
<body id="body">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#tabla').load('componentes/tablas/vista_tarjetas_habilitadas.php?estrategia=<?php echo $estrategia; ?>');
		});
	</script>
	<script type="text/javascript">
		$(document).ready(function() {
			$('#guardarnuevo').click(function() {
				...
				asunto = $('#asunto').val();
				mensaje = $('#mensaje').val();
				agregardatos(id_tarjeta, cedula, codigo, canjeada, fecha_creacion, fecha_venc, fecha_renova, estrategia_id, tar_estado_id, monto_id,
					email_remitente,
					email_destinatario,
					asunto,
					mensaje
